...
//    }
    ...
    @PostMapping(value = "/rss22/delete/{guid}")
    public ModelAndView deleteArticle(@PathVariable String guid, Model model) {
        ModelAndView modelAndView = new ModelAndView();
        ...
        if (item.isPresent()) {
            ...
            response = new Response("ERR_DEL", "ERROR", "ERREUR SUPPRESSION DE L'ARTICLE");
    ...
    public ModelAndView insertArticle(@ModelAttribute("formField") FormField field, Model model) throws FeedNotValidException, JAXBException, ParserConfigurationException, IOException, SAXException {
            ...
            if(valid) {
                ...
                if(itemObject.getPublished() != null) {
                    ...
                    if(exist == null ){
                        ...
                        modelAndView.setViewName("ajoutInfo");
                        Response response = new Response("NULL", "ERROR", "ARTICLE EXISTANT");
                        model.addAttribute("response", response);
                        return modelAndView;
                    }
...
//                                return new Response(null, "ERROR", createLongResponse(addedGuids,exist.getGuid(),"error"));
                ...
                Response response = new Response("Many", "INSERTED", "INSERTION MULTIPLE", addedGuids, refusedGuids);
                model.addAttribute("response", response);
                return modelAndView;
